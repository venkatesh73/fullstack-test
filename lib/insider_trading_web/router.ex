defmodule InsiderTradingWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {InsiderTradingWeb.Layouts, :root}
  ...
  scope "/", InsiderTradingWeb do
    pipe_through :browser

    get "/", PageController, :home
  end

  scope "/api", InsiderTradingWeb.Api do
    pipe_through :api

    get "/v1/inside_trade/:ticker", TradeInfoController, :index
  end
